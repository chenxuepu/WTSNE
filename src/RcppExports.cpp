...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Rtsne_cpp(X, no_dims, perplexity, theta, verbose, max_iter, distance_precomputed, Y_in, init, stop_lying_iter, mom_switch_iter, momentum, final_momentum, eta, exaggeration_factor, num_threads, weights));
...
RcppExport SEXP _wtsne_Rtsne_nn_cpp(SEXP nn_dexSEXP, SEXP nn_distSEXP, SEXP no_dimsSEXP, SEXP perplexitySEXP, SEXP thetaSEXP, SEXP verboseSEXP, SEXP max_iterSEXP, SEXP Y_inSEXP, SEXP initSEXP, SEXP stop_lying_iterSEXP, SEXP mom_switch_iterSEXP, SEXP momentumSEXP, SEXP final_momentumSEXP, SEXP etaSEXP, SEXP exaggeration_factorSEXP, SEXP num_threadsSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type weights(weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(Rtsne_nn_cpp(nn_dex, nn_dist, no_dims, perplexity, theta, verbose, max_iter, Y_in, init, stop_lying_iter, mom_switch_iter, momentum, final_momentum, eta, exaggeration_factor, num_threads, weights));
    return rcpp_result_gen;
END_RCPP
}
// normalize_input_cpp
Rcpp::NumericMatrix normalize_input_cpp(Rcpp::NumericMatrix input);
RcppExport SEXP _wtsne_normalize_input_cpp(SEXP inputSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_wtsne_Rtsne_cpp", (DL_FUNC) &_wtsne_Rtsne_cpp, 17},
    {"_wtsne_Rtsne_nn_cpp", (DL_FUNC) &_wtsne_Rtsne_nn_cpp, 17},
    {"_wtsne_normalize_input_cpp", (DL_FUNC) &_wtsne_normalize_input_cpp, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_wtsne(DllInfo *dll) {
